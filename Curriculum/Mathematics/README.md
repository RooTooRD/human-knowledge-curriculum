...
The [complete syllabus](syllabus.md) contains 85 observable
outcome statements across all 28 units. Each statement requires
...
**Subject entry units:** `MAT-B01`.

The exact cross-disciplinary gateway edges are:

| External prerequisite | Unlocks subject unit |
|---|---|
| [`CSC-B03`](../Computer-Science/roadmap.md) | [`MAT-A04`](roadmap.md) |
| [`FND-B02`](../Foundations/roadmap.md) | [`MAT-B01`](roadmap.md) |
| [`FND-B07`](../Foundations/roadmap.md) | [`MAT-B03`](roadmap.md) |
| [`FND-I03`](../Foundations/roadmap.md) | [`MAT-B08`](roadmap.md) |
| [`LOG-I01`](../Logic/roadmap.md) | [`MAT-I01`](roadmap.md) |
| [`LOG-I02`](../Logic/roadmap.md) | [`MAT-I08`](roadmap.md) |
| [`LOG-I03`](../Logic/roadmap.md) | [`MAT-A08`](roadmap.md) |
...
The [syllabus mastery column](syllabus.md) contains 56 binary
...
The [subject connection map](connections.md) links Mathematics to all 38 other
